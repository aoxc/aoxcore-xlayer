    ...
    EIP712Upgradeable
{
     ...
     */
    bytes32 private constant SENTINEL_STORAGE_LOCATION = 0x9331003666f7d025170d9e9e6f2bc8b671d1796c739a8976136f78816f1f6c00;
    ...
    bytes32 private constant NEURAL_PACKET_TYPEHASH = keccak256(
        "NeuralPacket(address origin,uint256 nonce,uint8 riskScore,bytes32 protocolHash,uint256 deadline)"
    );

    bytes32 private constant INTERCEPTION_TYPEHASH = keccak256(
        "Interception(uint8 riskScore,uint256 nonce,address target,bytes4 selector)"
    );
